...
var filesToCache = [
  ...
  "resources/images/icons/launcher-icon-0-75x.png",
  "resources/images/icons/launcher-icon-1-5x.png",
  "resources/images/icons/launcher-icon-1x.png",
  "resources/images/icons/launcher-icon-2x.png",
  "resources/images/icons/launcher-icon-3x.png",
  "resources/images/icons/launcher-icon-4x.png"
];
